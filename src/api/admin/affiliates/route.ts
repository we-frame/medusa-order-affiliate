...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  try {
    const customerService: CustomcusService =
      req.scope.resolve<CustomcusService>("customcusService");
...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
  try {
    ...
    const requestBody: CreateCustomerInput =
      req.body as any as CreateCustomerInput;
